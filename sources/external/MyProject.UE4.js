...
console.log('Emscripten version: C:/eng/UE_4.23/Engine/Extras/ThirdPartyNotUE/emsdk/emscripten/1.38.31');
console.log('Emscripten configuration: C:/eng/UE_4.23/Engine/Intermediate/Build/HTML5/.emscripten');
...
var Module = {
    ...
    UE4_indexedDBVersion: 202111121102, // Bump this number to invalidate existing IDB storages in browsers.
};
...
function detectWasmThreads() {
    return WebAssembly.validate(new Uint8Array([0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x04, 0x01, 0x60, 0x00, 0x00, 0x03, 0x02, 0x01, 0x00, 0x05, 0x04, 0x01, 0x03, 0x01, 0x01, 0x0a, 0x0b, 0x01, 0x09, 0x00, 0x41, 0x01, 0xfe, 0x10, 0x02, 0x00, 0x1a, 0x0b]));
}
...
Module['UE4_keyEvent'] = function (eventType, key, virtualKeyCode, domPhysicalKeyCode, keyEventStruct) {
    return 0;
};
Module['UE4_mouseEvent'] = function (eventType, x, y, button, buttons, mouseEventStruct) {
    return 0;
};
Module['UE4_wheelEvent'] = function (eventType, x, y, button, buttons, deltaX, deltaY, wheelEventStruct) {
    return 0;
};
...
*/
        ...
        if (precompileShaders) {
            var compileShaders = fetchOrDownloadAndStore(db, Module.locateFile('shaders.json'), 'arraybuffer').then(function (json) {
    ...
    // ----------------------------------------
    // GO !
    openIndexedDB(Module['UE4_indexedDBName'], Module['UE4_indexedDBVersion'] || 1)
        .then(withIndexedDB)
        .catch(function (e) {
            if (enableReadFromIndexedDB || enableWriteToIndexedDB) {
